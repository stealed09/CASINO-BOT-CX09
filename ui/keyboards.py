...
def admin_new_features_kb() -> InlineKeyboardMarkup:
    ...
    builder.row(
        InlineKeyboardButton(text="💀 Loser Board Count", callback_data="aset_loser_board_count"),
        InlineKeyboardButton(text="💀 Loser Max Amount", callback_data="aset_loser_board_max_amount"),
    )
    builder.row(
    ...
    builder.row(
        InlineKeyboardButton(text="🎁 Promo Codes", callback_data="admin_promo_panel"),
    )
    builder.row(InlineKeyboardButton(text="🔙 Back", callback_data="admin_panel"))
    return builder.as_markup()
