...
def pvp_menu_kb() -> InlineKeyboardMarkup:
    ...
    builder.row(InlineKeyboardButton(text="🪙 Coinflip Duel", callback_data="pvp_create_coinflip"))
...
def admin_new_features_kb() -> InlineKeyboardMarkup:
    ...
    builder.row(
        InlineKeyboardButton(text="🎲 Crash Min/Max", callback_data="aset_crash_min_bet"),
