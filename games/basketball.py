...
async def play_basketball(message: Message, bot: Bot, bet: float):
    ...
    try:
        ...
        logger.info(f"Basketball | user={user_id} | bet={bet} | value={value} | won={won}")
        return None  # balance already handled inside
