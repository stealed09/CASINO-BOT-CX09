...
async def play_bowling(message: Message, bot: Bot, bet: float):
    ...
    try:
        ...
        if won:
            ...
            result = (
                f"🎳 <b>BOWLING</b>\n{SEP}\nRolled: <b>{value}</b>  😢 <b>NO STRIKE!</b>\n"
                f"💸 -<b>{bet:,.4f} Tokens</b>"
            )
        ...
        logger.info(f"Bowling | user={user_id} | bet={bet} | value={value} | won={won}")
        return None
